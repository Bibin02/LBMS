...
('BK002', 'Book BBB', 'J.K. Rowling', 'Bloomsbury', 'fantasy,magic,wizard', 120, 15, 1.5, '{ "about": "A young wizards journey through magic, friendship, and adventure."}', '2001'),
('BK003', 'Book CCC', 'Yuval Noah Harari', 'Harvill Secker', 'history,evolution,science', 75, 5, 2.0, '{ "about": "An exploration of humanitys creation and evolution."}', '2001'),
('BK004', 'Book DDD', 'Jane Austen', 'T. Egerton', 'romance,classics,women', 30, 0, 5., '{ "about": "A romantic novel of manners set in 19th-century England."}', '2001'),
